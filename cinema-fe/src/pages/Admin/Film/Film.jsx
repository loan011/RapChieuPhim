                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((m, i) => (
                    <tr key={m.id} className="border-t border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="px-3 py-2">{m.duration} phút</td>
                      <td className="px-3 py-2">{m.director}</td>
                      <td className="px-3 py-2">{m.releaseDate}</td>
                      <td className="px-3 py-2">{m.status}</td>
                      <td className="px-3 py-2 flex gap-2">
                        <button className="text-blue-600 hover:underline text-xs" onClick={() => alert(`TODO: Sửa phim id=${m.id}`)}>Sửa</button>
                        <button className="text-red-500 hover:underline text-xs" onClick={() => handleDelete(m.id)}>Xóa</button>
                      </td>
                    </tr>
                  ))
                )}
