      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div className="flex flex-wrap gap-3 mb-6">
          <div className="flex-1 min-w-[280px] relative">
            <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-400"><MdSearch className="text-lg" /></span>
            <input
              type="text"
          ...
          <div className="relative">
            <span className="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-45 pointer-events-none"><MdFilterList className="text-lg" /></span>
            <select
        ...
        {!loading && !error && (
          <div className="overflow-x-auto rounded-xl border border-gray-100">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-gray-55/40 border-b border-gray-100 text-gray-600 font-semibold">
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((t, i) => (
                    <tr key={t.id || t.ticketId} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3.5"><span className="bg-gray-100 text-gray-805 px-2 py-0.5 rounded font-mono text-xs font-semibold">{t.seatCode}</span></td>
                      ...
                      <td className="px-4 py-3.5">
                        <div className="flex gap-3">
                          ...
                          <button
                            className="text-red-500 hover:text-red-700 hover:underline font-semibold text-xs flex items-center gap-0.5"
            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg mx-4 overflow-hidden border border-gray-100 animate-in fade-in zoom-in-95 duration-150">
              ...
              <form onSubmit={handleSubmitForm} className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      name="seatCode"
                      className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-50/50 transition-all duration-200 font-mono"
                ...
                <div>
                  ...
                  <select
                    name="status"
                    className="w-full border border-gray-200 rounded-xl px-4 py-2.5 text-sm bg-white focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-50/50 transition-all duration-200"
                ...
                <div className="flex justify-end gap-2 pt-4 border-t border-gray-50">
                  ...
                  <button
                    ...
                    className="px-5 py-2 text-sm font-semibold rounded-xl bg-green-600 text-white hover:bg-green-700 hover:shadow-lg hover:shadow-green-100 disabled:opacity-60 transition-all"
                  >
